package com.toasternetwork.games.graphics;

// https://github.com/ripred/JavaChess/blob/master/src/Ansi.java
...
public class Ansi {
    ...
    public static String mergeColors24(String clr1, String clr2, final boolean fore) {
        ...
        float r1 = Float.parseFloat(parts1[2]);
        float g1 = Float.parseFloat(parts1[3]);
        float b1 = Float.parseFloat(parts1[4].substring(0, parts1[4].length() - 1));

        float r2 = Float.parseFloat(parts2[2]);
        float g2 = Float.parseFloat(parts2[3]);
        float b2 = Float.parseFloat(parts2[4].substring(0, parts2[4].length() - 1));
